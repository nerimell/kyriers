 ...
 */
public class MySettingsView implements ForGameScreen {
    private MyEngine E;

    public MySettingsView(MyEngine E){
        this.E = E;
    }

    void dispose() {
        E.mySettings.DWNKey=-1;
        /*
        E.mySettings.dispose();
        E.mySettings=null;
        */
    }
    ...
    void Display(Viewport view) {
        if (E.mySettings.DWNKey >= 0) {
            Engine.inputListener.clnProces();
            switch (E.mySettings.DWNKey) {
                case 5:
                    E.screen = 0;
                    if(E.startMenu == null)
