 ...
 */
public class MySettings extends Stage implements ProcessorInput {
    ...
    public MySettings(MovingMenu leftMovingMenu, Sprite navbarSprite, ScreenButton navBarButton) {
